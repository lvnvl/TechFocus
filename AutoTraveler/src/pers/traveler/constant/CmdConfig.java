...
public interface CmdConfig {
    ...
    String WIN_KILL_APPIUM_SERVER = "tskill node";

    // check appium server
    String LINUX_CHECK_APPIUM_SERVER = "ps -ef |grep node |grep -v grep";
    String WIN_CHECK_APPIUM_SERVER = "tasklist |findstr node";
    
    // run post test step
    String RUN_POSTTEST_STEP = "./process_result.sh ";
}