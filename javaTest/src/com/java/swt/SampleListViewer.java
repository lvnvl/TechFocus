	...
	private void addButtons() {
		...
		buttonAdd.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				// String text = OptionPane.showInputDialog(shell, "New language
				// genre: ", "Add new element", null);
				// if(text != null) {
		...
		buttonModify.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				// String text = OptionPane.showInputDialog(shell, "Rename: ",
				// "Modify genre", language.genre);
				// if(text != null) {
				// language.genre = text;
				// }
