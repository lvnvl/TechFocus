...
import com.android.uiautomator.actions.NewScriptAction;
import com.android.uiautomator.actions.RunScriptAction;
...
public class UiAutomatorViewer extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
        ...
        toolBarManager.add(new NewScriptAction(this));
        toolBarManager.add(new RunScriptAction(this));
...
//        System.out.println("--------------------------");
    ...
    public void setModel(final UiAutomatorModel model, final String pageSource,
